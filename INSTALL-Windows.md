...
Note that you can (and should) install the Windows version of postgres even when running spn-core from within WSL.
...
- Open the solution `Builds\VisualStudio\spn-core.sln`
