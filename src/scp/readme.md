...
The `spn-core` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.spn.org/papers/spn-consensus-protocol.pdf).
