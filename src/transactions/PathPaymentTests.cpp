...
assetToString(const Asset& asset)
{
    ...
    switch (asset.type())
    {
    case spn::ASSET_TYPE_NATIVE:
        r = std::string{"XLM"};
        break;
    case spn::ASSET_TYPE_CREDIT_ALPHANUM4:
        assetCodeToStr(asset.alphaNum4().assetCode, r);
        break;
    case spn::ASSET_TYPE_CREDIT_ALPHANUM12:
...
TEST_CASE("pathpayment", "[tx][pathpayment]")
{
    ...
    {
        auto market = TestMarket{*app};
        // see https://github.com/spn/spn-core/pull/1239
        auto minimumAccount =
    ...
    SECTION("path payment with cycle")
    {
        for_all_versions(*app, [&] {
            ...
            auto validateOffer = [&](const TestAccount& account,
                ...
                auto offer =
                    spn::loadOffer(ls, account.getPublicKey(), offerId);
