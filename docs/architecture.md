...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "Stellar Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.spn.org/papers/spn-consensus-protocol.pdf).
...
- Set of core validator nodes. Running spn-core only. Tasked with:
...
- Set of public HTTP nodes. Not running spn-core. Running
...
- (optional): Set of public validator nodes. Running spn-core only. Tasked
with:
  ...
  - Basically just a spn-network load balancer / firewall for public access,
